...
\title{
    ...
    \Large{Assignment 2 - Architectural Patterns}
}
\date{\today}
...
\include{solved_problems}
\include{remaining_flaws}
\include{facade}

\begin{thebibliography}{5}
% TODO \bibitem{cite:REF} \emph{TITLE}, FROM, AUTHOR, \href{URL}{URL}
\bibitem{cite:gson} \emph{google-gson}, \href{https://code.google.com/p/google-gson/}{https://code.google.com/p/google-gson/}
\bibitem{cite:dom4j} \emph{dom4j}, \href{http://dom4j.sourceforge.net/}{http://dom4j.sourceforge.net/}
\bibitem{cite:doctrine} \emph{Doctrine}, \href{http://symfony.com/doc/current/book/doctrine.html}{http://symfony.com/doc/current/book/doctrine.html}
\end{thebibliography}
